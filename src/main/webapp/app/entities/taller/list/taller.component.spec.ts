...
describe('Taller Management Component', () => {
  let comp: TallerComponent;
  let fixture: ComponentFixture<TallerComponent>;
  let service: TallerService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'taller', component: TallerComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(TallerComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.tallers?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

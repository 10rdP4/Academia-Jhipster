...
export class SuscripcionComponent implements OnInit {
  ...
  trackId(index: number, item: ISuscripcion): number {
    return item.id!;
  }

  delete(suscripcion: ISuscripcion): void {
    const modalRef = this.modalService.open(SuscripcionDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onSuccess(data: ISuscripcion[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
